...
class InputFeatures(object):
    ...
    def __init__(self, input_ids, attention_mask, token_type_ids, label_idx, labels, mlm_labels=None):
        """
        ...
        :param label_idx: the label index in the label_list
